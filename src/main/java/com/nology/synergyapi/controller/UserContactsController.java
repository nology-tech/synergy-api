...
public class UserContactsController {
    ...
    @GetMapping("/contacts")
    public  ResponseEntity <List<UserContactBank>> getAllContacts () throws IOException {
        return ResponseEntity.status(HttpStatus.OK).body(userContactsService.getAllUsersWithBank());
    }
